...
def generate_dataset(n, id_mulai=1, seed=None):
    ...
    nama_depan = ["Umi", "Dewi", "Qori", "Hadi", "Fani", "Zainal", "Rini", "Joko"
                  "Wahyu", "Bambang", "Lestari", "Citra", "Dedi", "Andi", "Rizki", "Agus", "Ilham", "Dori", "Lopi", "Jarot", "Joko", "Jeruk", "Oki"]
    nama_belakang = ["Pratama", "Kusuma", "Santoso", "Saputra", "Handayani", "Mantapu", "Sitompul", "Haryadi", "Putri", "Putra", "Widodo"
                      "Wijaya", "Putri", "Siregar", "Nugroho", "Ramadhan", "Widodo"]
